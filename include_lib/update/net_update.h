...
#define CONFIG_UPGRADE_OTA_FILE_NAME_RES        "update-ota-res.ufw"

#define OTA_VERSON          "V1"                            //版本管理

//net_fopen支持写flash固件升级和写到SD卡，当名字字符有CCONFIG_UPGRADE_OTA_FILE_NAME时是固件升级
void *net_fopen(char *path, char *mode);

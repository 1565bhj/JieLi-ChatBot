...
#define    CFG_USER_WEBSKCET_IPADDR     2
#define    CFG_USER_ALARM               3
#define    CFG_USER_ALARM_URL0          4 //每个页256
#define    CFG_USER_ALARM_URL1          5 //每个页256
#define    CFG_USER_ALARM_URL2          6 //每个页256
#define    CFG_USER_ALARM_URL3          7 //每个页256
#define    CFG_USER_PROTECT             8
#define    CFG_USER_IRARC_INDEX         9
#define    CFG_USER_IRARC_KEY0          10 //红外遥控学习按键0，最多10个按键
#define    CFG_USER_IRARC_KEY1          11
#define    CFG_USER_IRARC_KEY2          12
#define    CFG_USER_IRARC_KEY3          13
#define    CFG_USER_IRARC_KEY4          14
#define    CFG_USER_IRARC_KEY5          15
#define    CFG_USER_IRARC_KEY6          16
#define    CFG_USER_IRARC_KEY7          17
#define    CFG_USER_IRARC_KEY8          18
#define    CFG_USER_IRARC_KEY9          19
#define    CFG_USER_IRARC_KEY10         20
#define    CFG_USER_LET_WIFI_SELECT     21 //WiFi和LTE-4G切换
#define    CFG_USER_CONFIG_DATA         22 //存储用户信息：最多240字节

#define    CFG_USER_ALARM_CONTENT0      23
#define    CFG_USER_ALARM_CONTENT1      24
#define    CFG_USER_ALARM_CONTENT2      25
#define    CFG_USER_ALARM_CONTENT3      26
#define    CFG_USER_ALARM_CONTENT4      27
#define    CFG_USER_ALARM_CONTENT5      28
#define    CFG_USER_ALARM_CONTENT6      29
#define    CFG_USER_ALARM_CONTENT7      30
#define    CFG_USER_ALARM_CONTENT8      31
#define    CFG_USER_ALARM_CONTENT9      32

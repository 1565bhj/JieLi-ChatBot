...
/***PWMCHx***/
#define PWMCH0_H        BIT(0)//PA3
#define PWMCH1_H        BIT(1)//PA7
#define PWMCH2_H        BIT(2)//PC7
#define PWMCH3_H        BIT(3)//PH0
#define PWMCH4_H        BIT(4)//PC0
#define PWMCH5_H        BIT(5)//PH3
#define PWMCH6_H        BIT(6)//PB2
#define PWMCH7_H        BIT(7)//PB6

#define PWM_CHL_OFFSET  10
#define PWMCH0_L        BIT(PWM_CHL_OFFSET + 0)//PA4
#define PWMCH1_L        BIT(PWM_CHL_OFFSET + 1)//PA8
#define PWMCH2_L        BIT(PWM_CHL_OFFSET + 2)//PC8
#define PWMCH3_L        BIT(PWM_CHL_OFFSET + 3)//PH1
#define PWMCH4_L        BIT(PWM_CHL_OFFSET + 4)//PC2
#define PWMCH5_L        BIT(PWM_CHL_OFFSET + 5)//PH7
#define PWMCH6_L        BIT(PWM_CHL_OFFSET + 6)//PB3
#define PWMCH7_L        BIT(PWM_CHL_OFFSET + 7)//PB7

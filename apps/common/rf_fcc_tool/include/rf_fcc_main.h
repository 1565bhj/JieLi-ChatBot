...
#define CONFIG_RF_FCC_TRIGGER_MODE   IO_TRIGGER_MODE//AUTO_STARTUP_MODE //RF_FCC触发方式配置

#define CONFIG_RF_FCC_TRIGGER_IO_PORT   IO_PORTC_06    //RF_FCC"IO检测"IO配置
#define CONFIG_RF_FCC_TRIGGER_IO_STATE  (0)            //RF_FCC"IO检测"IO的状态配置，0:低电平触发，1:高电平触发
#define CONFIG_RF_FCC_TRIGGER_IO_CNT    (5)           //RF_FCC"IO检测"IO的检测次数

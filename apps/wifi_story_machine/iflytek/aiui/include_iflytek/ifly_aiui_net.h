 ...
 * @return void。
 */
OAL_RESULT ifly_aiui_send_voice_start();
/**
 * @brief 发送识别音频数据。
 ...
 * @return OAL_RESULT。
 */
OAL_RESULT ifly_aiui_send_voice_data(const char *pp_voice_buf, int vp_len);
/**
 * @brief 发送识别结束/取消指令。
 * @param vp_end_type 预留
 * @return OAL_RESULT。
 */
OAL_RESULT ifly_aiui_send_voice_stop(unsigned char vp_end_type);
/**

...
#ifndef FORCE_DAC_SAMPLE_TRATE
#define FORCE_DAC_SAMPLE_TRATE 0
#endif
...
#endif
//#define CONFIG_IFLY_AIUI_SDK_ENABLE               // 使用IFY_AIUI平台
...
//#define CONFIG_NET_CFG_POWER_ON_START           //开启启动蓝牙配网模式
#endif
...
#define IFLYTEK_ALGORITHM   5 //科大讯飞平台
#define JLKWS_SXY_ALGORITHM 6 //杰理数芯语平台
#define KWS_YUNZS_ALGORITHM 7 //云之声平台
#define KWS_QYAI_ALGORITHM  8 //轻语AI平台

/* 本地打断唤醒算法选择 */
#define CONFIG_ASR_ALGORITHM  IFLYTEK_ALGORITHM
//#define CONFIG_ASR_ALGORITHM  KWS_QYAI_ALGORITHM
//#define CONFIG_ASR_ALGORITHM  KWS_YUNZS_ALGORITHM

#ifndef AUDIO_RECORD_MIC_COUNT
#define AUDIO_RECORD_MIC_COUNT  1      //1单麦,2双麦
#endif

#define ASR_SAMPLE_RATE         16000   //语音识别采样率

#define ASR_JL_AVD              1
#define ASR_WEBRTC_AVD          2
#define ASR_IFLY_AVD            3
#define ASR_MY_AVD              4

#if (CONFIG_ASR_ALGORITHM == JLKWS_SXY_ALGORITHM)
#define ASR_USED_AVD            ASR_JL_AVD       //使用杰理自带avd检测-不支持双麦
#else
#define ASR_USED_AVD            ASR_JL_AVD//ASR_MY_AVD//ASR_WEBRTC_AVD
#endif

#ifndef DIGITAL_VOL_AGC
#define DIGITAL_VOL_AGC         1       //AEC后的音频数字增益
#endif

#ifdef CONFIG_ASR_ALGORITHM
#ifndef PRODUCTION_TEST_ENABLE
#define WIFI_PCM_STREAN_SOCKET_ENABLE           //打开打断唤醒pcm音频流局域网传输工具
#endif
#endif

#ifndef SPEECH_ENERGY_MIN
#define SPEECH_ENERGY_MIN               (128)   //语音检测最小值能量值
#endif
#define CONFIG_IFLY_AEC_ASR_FOLLOW_VAD          //有语音才进行回音消除和语音识别-安静环境可降低20mA的功耗
#endif
#endif
...
#define CONFIG_AUDIO_LINEIN_SAMPLERATE 16000 //LINEIN采样率
#endif
...
#define CONFIG_UI_RES_FILE_PATH       "mnt/sdfile/EXT_RESERVED/uipackres/ui/"
#elif defined CONFIG_UI_FILE_SAVE_IN_RESERVED_ZONE
#define CONFIG_UI_RES_FILE_PATH       "mnt/sdfile/app/uipackres/ui/"
#else
#define CONFIG_UI_RES_FILE_PATH       "mnt/sdfile/res/ui_res/"
#endif
#define CONFIG_UI_FONT_RES_FILE_PATH  "mnt/sdfile/EXT_RESERVED/" //CONFIG_UI_RES_FILE_PATH //UI字库资源固定放在拓展预留区
#endif

#define CONFIG_IFLY_EN_MLP_RES_NAME              "mnt/sdfile/res/ifly_res/en_mlp.bin"
#define CONFIG_IFLY_EN_KEYWORD_RES_NAME          "mnt/sdfile/res/ifly_res/en_keywords.bin"

#define CONFIG_IFLY_MLP_RES_NAME                 "mnt/sdfile/res/ifly_res/mlp.bin"
#define CONFIG_IFLY_KEYWORD_RES_NAME             "mnt/sdfile/res/ifly_res/keywords.bin"

#define CONFIG_IFLY_XF_MLP_RES_NAME             "mnt/sdfile/res/ifly_res/xf_mlp.bin"
#define CONFIG_IFLY_XF_KEYWORD_RES_NAME         "mnt/sdfile/res/ifly_res/xf_keywords.bin"
...
#ifdef CONFIG_NO_SDRAM_ENABLE
#define TCFG_EQ_ENABLE                      0     //低内存版本不开启EQ功能
#else
...
#define TCFG_HOST_WIRELESS_ENABLE           1   //usb虚拟网卡
#define TCFG_ADB_ENABLE                     1
#endif
...
#define BLE_DEV_NAME                "XWAI_AC_"
#define BT_DEV_NAME                 "XWAI_"
#define BT_DEV_NAME_LONE_ENABLE            //升级设备名称长名称
#else
#define BLE_DEV_NAME                "QYAI_AC_"
#define BT_DEV_NAME                 "QYAI_"
#endif
...
#define BT_SUPPORT_WIFI_CFG_COEXISTENCE           1     //wifi配网时保持蓝牙连接
...
#define TCFG_LCD_ST7789V_ENABLE             0 //2.1寸320*240屏幕
#define TCFG_LCD_JD9853_ENABLE              0
#define TCFG_LCD_GC3907_ENABLE              0
...
#if TCFG_LCD_NV3031A_ENABLE && (!defined TCFG_TOUCH_GST820_ENABLE)
#define TCFG_TOUCH_GST820_ENABLE            1 //触摸
#elif TCFG_LCD_ST7789V_ENABLE && (!defined TCFG_TOUCH_GST328_ENABLE)
#define TCFG_TOUCH_GST328_ENABLE            1 //触摸
#elif TCFG_LCD_AXS15252_ENABLE
#define TCFG_TOUCH_AXS15252_ENABLE          1
#endif
...
#if TCFG_LCD_480x272_8BITS || TCFG_LCD_ILI9341_ENABLE || TCFG_LCD_ILI9481_ENABLE || TCFG_LCD_JD9853_ENABLE || TCFG_LCD_GC3907_ENABLE
#define HORIZONTAL_SCREEN                   0//0为使用竖屏
#else
#define HORIZONTAL_SCREEN                   1//1为使能横屏配置
#endif

#if TCFG_LCD_JD9853_ENABLE || TCFG_LCD_AXS15252_ENABLE
#define USE_LCD_TE                          1 //使用TE信号解决撕裂现象
#endif

#if (TCFG_LCD_ST77912_ENABLE || TCFG_LCD_ST7789P3_ENABLE)
#define LCD_W     240
#define LCD_H     240
#elif TCFG_LCD_GC9D01_ENABLE
#define LCD_W     160
#define LCD_H     160
#elif TCFG_LCD_ST7735P3_ENABLE
#define LCD_W     160
#define LCD_H     128
#elif TCFG_LCD_JD9853_ENABLE
#define LCD_W     320
#define LCD_H     240
#elif TCFG_LCD_AXS15252_ENABLE
#define LCD_W     320

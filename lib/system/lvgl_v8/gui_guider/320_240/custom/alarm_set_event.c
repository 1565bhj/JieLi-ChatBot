...
static void alarm_set_yes_event_handler(lv_event_t *e) {
    ...
    if(code == LV_EVENT_CLICKED) {
        ...
        // 保存闹钟设置，传递星期选择信息
        Sync_ui_dynamic_add_new_alarm(ui, g_alarm_hour, g_alarm_minute, 0, g_alarms[g_current_alarm_index].repeat_status);
...
static void alarm_set_btn_weekday_event_handler(lv_event_t *e) {
    ...
    if(code == LV_EVENT_CLICKED) {
        ...
        if(target == ui->screen_alarm_set_btn_1) btn_index = 0;
        else if(target == ui->screen_alarm_set_btn_2) btn_index = 1;
        else if(target == ui->screen_alarm_set_btn_3) btn_index = 2;
        else if(target == ui->screen_alarm_set_btn_4) btn_index = 3;
        else if(target == ui->screen_alarm_set_btn_5) btn_index = 4;
        else if(target == ui->screen_alarm_set_btn_6) btn_index = 5;
        else if(target == ui->screen_alarm_set_btn_7) btn_index = 6;

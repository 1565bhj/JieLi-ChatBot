...
void setup_scr_screen_podcast(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_img_src(ui->screen_podcast, &_bg_320x240, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_opa(ui->screen_podcast, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_recolor_opa(ui->screen_podcast, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Write codes screen_podcast_slider_1
    ui->screen_podcast_slider_1 = lv_slider_create(ui->screen_podcast);
    lv_slider_set_range(ui->screen_podcast_slider_1, 0, 100);
    lv_slider_set_mode(ui->screen_podcast_slider_1, LV_SLIDER_MODE_NORMAL);
    lv_slider_set_value(ui->screen_podcast_slider_1, 0, LV_ANIM_OFF);
    lv_obj_set_pos(ui->screen_podcast_slider_1, 45, 164);
    lv_obj_set_size(ui->screen_podcast_slider_1, 231, 4);

    //Write style for screen_podcast_slider_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_podcast_slider_1, 80, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_podcast_slider_1, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_podcast_slider_1, LV_GRAD_DIR_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_podcast_slider_1, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui->screen_podcast_slider_1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_podcast_slider_1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Write style for screen_podcast_slider_1, Part: LV_PART_INDICATOR, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_podcast_slider_1, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_podcast_slider_1, lv_color_hex(0xffffff), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_podcast_slider_1, LV_GRAD_DIR_NONE, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_podcast_slider_1, 8, LV_PART_INDICATOR | LV_STATE_DEFAULT);

    //Write style for screen_podcast_slider_1, Part: LV_PART_KNOB, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_podcast_slider_1, 255, LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_podcast_slider_1, lv_color_hex(0xffffff), LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_podcast_slider_1, LV_GRAD_DIR_NONE, LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_podcast_slider_1, 8, LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    lv_spangroup_set_mode(ui->screen_podcast_time_end, LV_SPAN_MODE_BREAK);
    //create span
    ...
    //Write codes screen_podcast_blog_title
    ui->screen_podcast_blog_title = lv_spangroup_create(ui->screen_podcast);
    lv_spangroup_set_align(ui->screen_podcast_blog_title, LV_TEXT_ALIGN_LEFT);
    lv_spangroup_set_overflow(ui->screen_podcast_blog_title, LV_SPAN_OVERFLOW_CLIP);
    lv_spangroup_set_mode(ui->screen_podcast_blog_title, LV_SPAN_MODE_BREAK);
    //create span
    ui->screen_podcast_blog_title_span = lv_spangroup_new_span(ui->screen_podcast_blog_title);
    lv_span_set_text(ui->screen_podcast_blog_title_span, "轻语博客");
    lv_style_set_text_color(&ui->screen_podcast_blog_title_span->style, lv_color_hex(0xffffff));
    lv_style_set_text_decor(&ui->screen_podcast_blog_title_span->style, LV_TEXT_DECOR_NONE);
    lv_style_set_text_font(&ui->screen_podcast_blog_title_span->style, &lv_font_MiSansDemibold_18);
    lv_obj_set_pos(ui->screen_podcast_blog_title, 130, 131);
    lv_obj_set_size(ui->screen_podcast_blog_title, 94, 22);

    //Write style state: LV_STATE_DEFAULT for &style_screen_podcast_blog_title_main_main_default
    static lv_style_t style_screen_podcast_blog_title_main_main_default;
    ui_init_style(&style_screen_podcast_blog_title_main_main_default);

    lv_style_set_border_width(&style_screen_podcast_blog_title_main_main_default, 0);
    lv_style_set_radius(&style_screen_podcast_blog_title_main_main_default, 0);
    lv_style_set_bg_opa(&style_screen_podcast_blog_title_main_main_default, 0);
    lv_style_set_pad_top(&style_screen_podcast_blog_title_main_main_default, 0);
    lv_style_set_pad_right(&style_screen_podcast_blog_title_main_main_default, 0);
    lv_style_set_pad_bottom(&style_screen_podcast_blog_title_main_main_default, 0);
    lv_style_set_pad_left(&style_screen_podcast_blog_title_main_main_default, 0);
    lv_style_set_shadow_width(&style_screen_podcast_blog_title_main_main_default, 0);
    lv_obj_add_style(ui->screen_podcast_blog_title, &style_screen_podcast_blog_title_main_main_default, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_spangroup_refr_mode(ui->screen_podcast_blog_title);
    ...
    lv_img_set_src(ui->screen_podcast_img_music, &_groove_alpha_234x140);
    lv_img_set_pivot(ui->screen_podcast_img_music, 115, 70);
    lv_img_set_angle(ui->screen_podcast_img_music, 0);
    lv_obj_set_pos(ui->screen_podcast_img_music, 120, 19);
    lv_obj_set_size(ui->screen_podcast_img_music, 234, 140);
    ...
    lv_obj_set_pos(ui->screen_podcast_img_tape_right, 358, 52);
    ...
    lv_obj_set_pos(ui->screen_podcast_img_tape_left, 26, 52);
    ...
    lv_img_set_angle(ui->screen_podcast_img_bar, 110);
    ...
    lv_obj_set_style_text_font(ui->screen_podcast_btn_play_pause, &lv_font_montserratMedium_16, LV_PART_MAIN | LV_STATE_DEFAULT);

...
void setup_scr_screen_timer_remove(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->screen_timer_remove_imgbtn_del3, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui->screen_timer_remove_imgbtn_del3, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_text_font(ui->screen_timer_remove_imgbtn_del2, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui->screen_timer_remove_imgbtn_del2, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_text_font(ui->screen_timer_remove_imgbtn_del1, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui->screen_timer_remove_imgbtn_del1, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_CHECKED);
...
//    lv_obj_set_style_pad_all(ui->screen_timer_remove_return, 20);
    ...
    lv_obj_set_style_text_font(ui->screen_timer_remove_imgbtn_choice, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui->screen_timer_remove_imgbtn_choice, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_CHECKED);
...
//    lv_obj_set_style_pad_all(ui->screen_timer_remove_imgbtn_choice, 20);

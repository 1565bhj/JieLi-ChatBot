...
//    lv_obj_set_style_pad_all(ui->screen_alarm_add_yes, 20, LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_alarm_add_add_alarm_name, 115, 22);
...
//    lv_obj_set_style_pad_all(ui->screen_alarm_add_return, 20);
...
//    lv_obj_set_style_pad_all(ui->screen_alarm_add_cont_repeat, 20);

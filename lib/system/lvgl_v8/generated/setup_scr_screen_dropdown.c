...
//    lv_obj_set_style_pad_all(ui->screen_dropdown_imgbtn_mic, 20);
    ...
    lv_obj_set_style_text_font(ui->screen_dropdown_imgbtn_mic, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_dropdown_imgbtn_mic, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui->screen_dropdown_imgbtn_mic, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_CHECKED);
...
//    lv_obj_set_style_pad_all(ui->screen_dropdown_imgbtn_speaker, 20);
    ...
    lv_obj_set_style_text_font(ui->screen_dropdown_imgbtn_speaker, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_dropdown_imgbtn_speaker, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui->screen_dropdown_imgbtn_speaker, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_CHECKED);
...
//    lv_obj_set_style_pad_all(ui->screen_dropdown_imgbtn_BT, 20);
    ...
    lv_obj_set_style_text_font(ui->screen_dropdown_imgbtn_BT, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_dropdown_imgbtn_BT, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui->screen_dropdown_imgbtn_BT, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_CHECKED);
...
//    lv_obj_set_style_clip_corner(ui->screen_dropdown_img_set_wifi, true, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_dropdown_img_normal_battery, BATTERY_ICON_X, BATTERY_ICON_Y);
    ...
    lv_obj_set_pos(ui->screen_dropdown_img_no_wifi, WIFI_ICON_X, WIFI_ICON_Y);
    ...
    lv_obj_set_pos(ui->screen_dropdown_img_no_BT, BLUETOOTH_ICON_X, BLUETOOTH_ICON_Y);
    ...
    lv_obj_set_pos(ui->screen_dropdown_img_no_alarm, ALARM_ICON_X, ALARM_ICON_Y);
    ...
    lv_obj_set_size(ui->screen_dropdown_time, 60, 16);
    ...
    lv_bar_set_value(ui->screen_dropdown_volumn_bar, 70, LV_ANIM_OFF);
...
//    lv_obj_set_style_pad_all(ui->screen_dropdown_volumn_bar, 20);
    ...
    lv_bar_set_value(ui->screen_dropdown_light_bar, 100, LV_ANIM_OFF);
...
//    lv_obj_set_style_pad_all(ui->screen_dropdown_light_bar, 20);

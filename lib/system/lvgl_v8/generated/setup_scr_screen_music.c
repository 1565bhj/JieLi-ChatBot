...
//    lv_obj_set_style_pad_all(ui->screen_music_img_bar, 30, LV_STATE_DEFAULT);
...
//    lv_obj_set_style_pad_all(ui->screen_music_img_volume, 30, LV_STATE_DEFAULT);
...
//    lv_obj_set_style_pad_all(ui->screen_music_img_next, 30, LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_music_img_prev, 97, 197);
...
//    lv_obj_set_style_pad_all(ui->screen_music_img_prev, 30, LV_STATE_DEFAULT);
    ...
    //Write codes screen_music_label_title
    ui->screen_music_label_title = lv_label_create(ui->screen_music);
    lv_label_set_text(ui->screen_music_label_title, "歌名加载中……");
    lv_obj_set_style_text_color(ui->screen_music_label_title, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_decor(ui->screen_music_label_title, LV_TEXT_DECOR_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_music_label_title, &lv_font_MiSansDemibold_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(ui->screen_music_label_title, 120, 50);
    lv_obj_set_size(ui->screen_music_label_title, 170, 22);


    // 设置文本对齐方式（居中）
    lv_obj_set_style_text_align(ui->screen_music_label_title, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    // 优化滚动设置
//    lv_label_set_long_mode(ui->screen_music_label_title, LV_LABEL_LONG_DOT);
    lv_label_set_long_mode(ui->screen_music_label_title, LV_LABEL_LONG_SCROLL_CIRCULAR);

    // 确保文本居中对齐，但需要配合标签高度限制以避免垂直滚动
    lv_obj_set_style_text_align(guider_ui.screen_music_label_title, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN);

    // 确保标签足够高以显示一行文本，避免垂直滚动
    lv_obj_set_height(guider_ui.screen_music_label_title, lv_font_get_line_height(lv_obj_get_style_text_font(guider_ui.screen_music_label_title, LV_PART_MAIN)) + 4);

    lv_obj_set_style_anim_speed(guider_ui.screen_music_label_title, 20, LV_PART_MAIN);
    //Write style state: LV_STATE_DEFAULT for &style_screen_music_label_title_main_main_default
    static lv_style_t style_screen_music_label_title_main_main_default;
    ui_init_style(&style_screen_music_label_title_main_main_default);

    lv_style_set_border_width(&style_screen_music_label_title_main_main_default, 0);
    lv_style_set_radius(&style_screen_music_label_title_main_main_default, 0);
    lv_style_set_bg_opa(&style_screen_music_label_title_main_main_default, 0);
    lv_style_set_pad_top(&style_screen_music_label_title_main_main_default, 0);
    lv_style_set_pad_right(&style_screen_music_label_title_main_main_default, 0);
    lv_style_set_pad_bottom(&style_screen_music_label_title_main_main_default, 0);
    lv_style_set_pad_left(&style_screen_music_label_title_main_main_default, 0);
    lv_style_set_shadow_width(&style_screen_music_label_title_main_main_default, 0);
    lv_obj_add_style(ui->screen_music_label_title, &style_screen_music_label_title_main_main_default, LV_PART_MAIN | LV_STATE_DEFAULT);


    //Write codes screen_music_lyric
    ui->screen_music_lyric = lv_label_create(ui->screen_music);
    lv_label_set_text(ui->screen_music_lyric, "歌词加载中……");
    ...
    lv_spangroup_set_mode(ui->screen_music_span_start, LV_SPAN_MODE_EXPAND);
    //create span
    ...
    lv_spangroup_set_mode(ui->screen_music_span_end, LV_SPAN_MODE_EXPAND);
    //create span
    ...
    lv_obj_set_size(ui->screen_music_bar_volume, 11, 100);
    ...
    lv_obj_set_style_text_font(ui->screen_music_imgbtn_mode, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui->screen_music_imgbtn_mode, &lv_font_MiSansDemibold_12, LV_PART_MAIN | LV_STATE_CHECKED);

 ...
 *====================*/
#define LV_CONF_INCLUDE_SIMPLE
//#define MY_DISP_HOR_RES        230//LCD_H
//#define MY_DISP_VER_RES        320//LCD_W
...
#define LV_DISP_DEF_REFR_PERIOD 20 //30      /*[ms]*/ //使用lvgl线程配置最低优先级全占据cpu的方法
...
#define LV_USE_PERF_MONITOR 0 //FPS显示
...
#define LV_USE_DEMO_BENCHMARK 0 //Benchmark 测试
